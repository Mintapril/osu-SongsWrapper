...
namespace MapCollator
{
    class Program
    {
        static void Main()
        {
            ...
            string packName = Console.ReadLine().ToString();
            if (packName == String.Empty)
            {
                packName = "Collection 1st";
            }
            Console.Write("Artists:");
            string artists = Console.ReadLine().ToString();
            if (artists == String.Empty)
            {
                artists = "Various";
            }
            Console.Write("Creator:");
            string creator = Console.ReadLine().ToString();
            if (creator == String.Empty)
            {
                creator = "mint";
            }
            Console.Write("HP:");
            string HP = Console.ReadLine().ToString();
            if (HP == String.Empty)
            {
                HP = "9";
            }
            Console.Write("OD:");
            string OD = Console.ReadLine().ToString();
            if (OD == String.Empty)
            {
                OD = "7.5";
            }
    ...
    class IO
    {
        public static List<string> ReadFile(string path, string packName, string artists, string creator, string HP, string OD, string folderName)
        {
            ...
            {
                Console.WriteLine(e.ToString() , "\nNo audio or background file found, ignored.");
            }
            catch (IOException)
            {
        ...
        public static void PackToOsz(string rootPath)
        {
            ...
            Console.WriteLine("Packaged successfully!\nPress any key to continue...");
        }
    }
}
